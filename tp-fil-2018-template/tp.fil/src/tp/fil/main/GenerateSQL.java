 ...
 * @generated
 */
public class GenerateSQL extends AbstractAcceleoGenerator {
    /**
     * The name of the module.
     *
     * @generated
     */
    public static final String MODULE_FILE_NAME = "/tp/fil/main/generateSQL";
     ...
     * @generated
     */
    public GenerateSQL(URI modelURI, File targetFolder,
     ...
     * @generated
     */
    public GenerateSQL(EObject model, File targetFolder,
            List<? extends Object> arguments) throws IOException {
    ...
    public static void main(String[] args) {
        try {
            if (args.length < 2) {
                ...
                GenerateSQL generator = new GenerateSQL(modelURI, folder, arguments);
